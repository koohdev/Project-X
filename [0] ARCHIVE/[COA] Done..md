...
4.1 Prototyping Model 54

4.1.1 Requirements Gathering 54

4.1.2 Quick Design 55

4.1.3 Building Prototype 55

4.1.4 Customer Evaluation of Prototype 55

4.1.5 Refining Prototype 56

4.1.6 Engineer Product 56

4.2 Requirements Specification 57

4.2.1 Operational Feasibility 57

4.2.2 Technical Feasibility 59

4.2.3 Schedule Feasibility 61

4.2.4 Economic Feasibility 66

4.2.5 Requirements Modeling 68

4.2.6 Risk Assessment/Analysis 82

4.3 Design 82

4.3.1 Output and User-interface Design 82

4.3.2 Data Design 84

4.3.3 System Architecture 84

4.4 Development 85

4.4.1 Software Specification 85

4.4.2 Hardware Specification 86

4.4.3 Program Specification 86

4.4.4 Programming Environment 89

4.4.5 Test Plan 90

4.5 Verification, Validation, Testing 91

4.5.1 Unit Testing 91

4.5.2 Integration Testing 92

4.6 Acceptance Testing 93

4.7 Implementation Plan 94

4.7.1 Physical Environment 94

4.7.2 Interfaces 94

4.7.3 Functionality 94

4.7.4 Data 94

4.7.5 Security 95

4.8 Installation Processes 96

5.0 Conclusion and Recommendations 97
...
Appendix A: Work Assignments A1-

Appendix B: Definition of Terms B1-

Appendix C: Database Design C1-

Appendix D: Screen Design D1-

Appendix E: Evaluation Tools/ Test Documents and Test Results E1-

Appendix F: Certifications and Letters F1-

Appendix G: Program Listings G1-

Appendix H: User’s Manual H1-

Appendix I: Curriculum Vitae I1-

Appendix J: Story, Characters, Items, Character Classes and Biomes J1-

**List of Tables**

Table #1 November 2025 Gantt Chart 61

Table #2 December 2025 Gantt Chart 61

Table #3 January 2026 Gantt Chart 62

Table #4 February 2026 Gantt Chart 62

Table #5 March 2026 Gantt Chart 63

Table #6 April 2026 Gantt Chart 63

Table #7 May 2026 Gantt Chart 63

Table #8 June 2026 Gantt Chart 64

Table #9 July 2026 Gantt Chart 64

Table #10 August 2026 Gantt Chart 65

Table #11 September 2026 Gantt Chart 66

Table #13 Cost and Benefits Table 66

Table # 14: System Information 85

Table # 15: System Information 86

Table #16: Program Specification 86
...
Table #33 Performance Test Result (Web Desktop) 14

Table #34 Performance Test Result (Web Mobile) 18

Table #35 Stress Testing Result 22

Table #36 Acceptance Testing Result 23
...
Figure No. 7 : Prototyping Model 54

Figure No. 8: Fishbone Diagram 57

Figure No. 9: Functional Decomposition Diagram 58

Figure No. 10: Player Use Case Diagrams 68

Figure No. 9: Auto Quest Sequence Diagram 69

Figure No. 10: Enemy Auto-Scaling Sequence Diagram 70

Figure No. 11: Level-Based Progression Sequence Diagram 71

Figure No. 12: Math Battle System Sequence Diagram 72

Figure No. 13: P2P Multiplayer Sequence Diagram 73

Figure No. 14: Save Sequence Diagram 74

Figure No. 15: Title Screen Module Activity Diagram 75

Figure No. 16: Figure: Exploration, Main Menu and Save Module Activity Diagram 76

Figure No. 17: Enemy Auto-Scaling Module Activity Diagram 77

Figure No. 18: Math Battle System Module Activity Diagram 78

Figure No. 16 : Dark Blue, Black and White 82

Figure No. 17: Chronicles of Arithmos Logo 83

Figure No. 18: M+ 1m regular Font 83
...
In this phase, proponents converted gathered requirements into tangible system blueprints and interface schematics across two iterations. During the first iteration, the proponents drafted navigation flowcharts, combat state transitions, and environmental storyboards for the initial Forest region to establish baseline enemy placements and spatial pathing. During the second iteration, the proponents expanded the visual schematics to encompass the Desert, Tundra, and Volcano biomes while designing on-screen virtual numeric keypad layouts for mobile touchscreen gameplay..

### 4.1.3 Building Prototype

In this phase, prototype construction translated design schematics into functional software within the RPG Maker MZ engine across two iterations. In the first iteration, the proponents authored custom JavaScript plugins for procedural arithmetic generation, configured the Performance-Based Reward multiplier logic, integrated the Content-Aware Timer, and established baseline WebRTC peer-to-peer multiplayer communication via PeerJS. In the second iteration, the proponents integrated the remaining three biome maps (Desert, Tundra, and Volcano), scripted procedural side quest routines for non-player characters (NPCs), and implemented the Virtual Numeric Keypad plugin for mobile touchscreens.

### 4.1.4 Customer Evaluation of Prototype

In this phase, customer evaluation assessed prototype functionality across two testing iterations. During the first iteration, the proponents conducted internal alpha testing to isolate source code defects and verify the stability of the core math-combat loop in a controlled setting through unit and integration tests. During the second iteration, the proponents administered randomized beta testing sessions involving 9-to-12-year-old Grade 4 to 6 student participants. These evaluation sessions enabled the proponents to observe user interface usability, touch input responsiveness, and difficulty scaling.

### 4.1.5 Refining Prototype

Following the data collections, the proponents addressed defects, balance irregularities, and usability issues discovered during user evaluations. In the first iteration, following internal alpha testing, the proponents re-calibrated mathematical damage formulas, fine-tuned timer duration weights, and anomalies. In the second iteration, following student beta testing, the proponents eliminated irregular enemy attribute difficulty curves, enlarged mobile user interface buttons to facilitate precision on smaller screens, and resolved peer-to-peer data synchronization.

### 4.1.6 Engineer Product

In the final phase, proponents consolidated all verified modules from both iterations into a stable, multi-platform release after fulfilling user acceptance criteria. The proponents executed final verification. Additionally, the proponents compiled the game into a standalone desktop executable (.exe) using NW.js for offline use on Windows computers and deployed the web build via Hostinger platform for online browser access.
...
| 1. System Navigation & Combat Transition Flowcharts |  |  |  |  |
| 1. User Interface (UI) Schematics & Interaction States |  |  |  |  |
| 1. Environmental Storyboarding & Spatial Pathing (Forest) |  |  |  |  |
...
| --- | --- | --- | --- | --- |
| Activities | Week 1 | Week 2 | Week 3 | Week 4 |
| Bulding Prototype 1st Iteration | | | | |
...
| 1. PeerJS WebRTC Multiplayer Integration |  |  |  |  |
| 1. Oral Defense |  |  |  |  |
...
| Customer Evaluation 1st Iteration Alpha Testing | | | | |
| 1. Unit Testing |  |  |  |  |
| 1. Integration Testing |  |  |  |  |
| Refining Prototype 1st Iteration | | | | |
| 1. Math Problem Tuning & Timer Weight Adjustments, Bug Fixes |  |  |  |  |
| 1. Capstone Adviser Consultation |  |  |  |  |
...
| --- | --- | --- | --- | --- |
| Activities | Week 1 | Week 2 | Week 3 | Week 4 |
| Quick Design 2nd Iteration | | | | |
| 1. Mobile Virtual Keypad & Biome Pathing (Desert/Tundra/Volcano) |  |  |  |  |
| Bulding Prototype 2nd Iteration | | | | |
| 1. Mobile Virtual Keypad Plugin & Multi-Biome Maps |  |  |  |  |
| 1. Procedural Side Quests & Room Sockets Integration |  |  |  |  |
| Customer Evaluation 2nd Iteration Beta Testing | | | | |
| 1. Randomized Student Beta Testing (Grades 4–6, Ages 9–12) |  |  |  |  |
| 1. Usability & Difficulty Scaling Observational Evaluation |  |  |  |  |
| Refining Prototype 2nd Iteration | | | | |
| 1. Enemy Attribute Scaling (Difficulty Tuning) |  |  |  |  |
| 1. GUI Button Re-sizing for Mobile Phone Screen |  |  |  |  |
| 1. Multiplayer Module Synchronization Bug Fixes |  |  |  |  |
| 1. Capstone Adviser Consultation |  |  |  |  |
...
| --- | --- | --- | --- | --- |
| Activities | Week 1 | Week 2 | Week 3 | Week 4 |
| Engineer Product 2nd and last Iteration | | | | |
...
4. Click or tap the "Play in browser" button on the main page to be redirected to the game subdomain at "https://app.chroniclesofarithmos.site".
...
The proponents conducted a survey with a total of 8 target participants, which included students, to evaluate the Chronicles of Arithmos application. The survey aimed to evaluate various aspects of the software, including the content, module design, multimedia elements, navigation, and overall usefulness.

* Content

A significant majority of the respondents found the content clear, easy to understand, informative, and user friendly. The tabulated results showed that 100 percent of the participants agreed that the overall text and presentation of the game are clear.

* Module

The core features such as the Math Battle System, Level Difficulty System, and Saving System achieved high satisfaction rates. The respondents confirmed that the mechanics function properly and that the dynamic equations adjust to the player level correctly.

* Multimedia Element

The participants rated the appropriateness of the font types, font sizes, images, colors, icons, and buttons positively. The results demonstrate the visual functionality and proper interface design of the application.

* Navigation

The navigation of the application received high ratings, with users confirming that moving between game menus is simple and that the directions are clear and concise.

* Usefulness

The utility of the application for practicing math equations, providing offline entertainment, and improving quick problem solving under a time limit was confirmed by the respondents.
...
In the Performance Reward Mechanism, the proponents recommend introducing visual achievement badges or trophies. This addition will give users a clearer sense of progression and further motivate them to consistently answer the math equations correctly and rapidly.
...
**![20260823_171809](data:image/jpeg;base64...)**

**![20260823_165415](data:image/jpeg;base64...)**

**![IMG_20260823_164518](data:image/jpeg;base64...)**

**![Screenshot 2026-08-23 215500](data:image/png;base64...)**

Appendix F: Certifications and Letters
