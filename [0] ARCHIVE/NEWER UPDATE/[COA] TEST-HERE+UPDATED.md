...
Unit Testing Result (see Table # on page E-3)
...
Compatibility Testing Result (see Table # on page E-7)
...
Stress Testing Result (see Table # on page #)
...
After the alpha testing phase the proponents conducted beta testing by using the nearly final version of the Chronicles of Arithmos application. For this testing phase the proponents gathered 20 target users to play the game and provide their feedback. These selected users including students played the game and evaluated its usability, navigation features, content, and overall learning experience. The proponents collected this feedback through a survey to determine how well the application helps users practice arithmetic equations under a time limit. The results indicated that the 20 target users found the game clear, user friendly, and effective for educational offline practice.

Survey Result (see Table # on page #)
...
Table #19 Compatibility Test Result (Web Desktop)
...
Table #20 Compatibility Test Result (Windows)
...
Table #21 Compatibility Test Result (Mobile Web)
...
Table #22 Performance Test Result (Windows)

|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| ***Module*** | ***Action*** | ***Concurrent Users*** | ***Pacing Time*** | ***Response Time*** |
| ***System Initialization*** |  |  |  |  |
|  | Initiate application when the game executable is launched. | - | 5 seconds |  |
|  | Display the Title Screen interface (New Game, Continue, Options, Quit Game). | - | - |  |
|  | Display the Options interface when options is selected. | - | 3 seconds |  |
|  | Load local save file data when Continue is selected. | - | 5 seconds |  |
...
Table #23 Performance Test Result (Web Desktop)

|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| ***Module*** | ***Action*** | ***Concurrent Users*** | ***Pacing Time*** | ***Response Time*** |
| ***System Initialization*** |  |  |  |  |
|  | Initiate application when the web page is launched. | - | 5 seconds |  |
|  | Display the Title Screen interface (New Game, Continue, Options, Quit Game). | - | - |  |
|  | Display the Options interface when options is selected. | - | 3 seconds |  |
|  | Load local save file data when Continue is selected. | - | 5 seconds |  |
|  | Exit application when the quit option is selected. | - | 3 seconds |  |
...
Table #24 Performance Test Result (Web Mobile)
...
Table #25 Stress Testing Result

|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| **Module** | **Test Scenario** | **Concurrent Users** | **Average Response Time** | **Expected Result** |
| Web Asset Delivery | Initial web page boot and registration of the service worker | 25 |  |  |
| Web Asset Delivery | Concurrent downloading and caching of core engine scripts and game database files | 25 |  |  |
| Web Asset Delivery | Concurrent downloading and caching of heavy visual graphics and audio assets for offline play | 25 |  |  |
| Web Asset Delivery | Verifying the service worker cache for updates upon launching the application | 25 |  |  |
...
| **Content** |  |  |  |  |  |  |
| The content of Chronicles of Arithmos is clear |  |  |  |  |  |  |
| The content of Chronicles of Arithmos is easy to understand |  |  |  |  |  |  |
| The content of Chronicles of Arithmos is informative and interesting |  |  |  |  |  |  |
| The content of Chronicles of Arithmos is user friendly |  |  |  |  |  |  |
| **Module** |  |  |  |  |  |  |
| Standard RPG Combat Mechanics |  |  |  |  |  |  |
| Math Battle System |  |  |  |  |  |  |
...
| Moving between game menus is simple |  |  |  |  |  |  |
| **Usefulness** |  |  |  |  |  |  |
| Chronicles of Arithmos is useful for practicing math equations |  |  |  |  |  |  |
| Chronicles of Arithmos is useful for offline entertainment |  |  |  |  |  |  |
| Chronicles of Arithmos is useful for improving quick problem solving under a time limit |  |  |  |  |  |  |
