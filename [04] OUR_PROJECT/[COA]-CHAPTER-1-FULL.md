...
To achieve these goals, the proposed game will be named Chronicles of Arithmos. The system will be developed using the RPG Maker MZ engine. The game will function as a standalone application that players will be able to launch on Windows computers and web browsers. It will also feature a Virtual Numeric Keypad so it will be accessible on touch-screen devices.

Many educational games will fail to keep players interested because of the "Chocolate-Covered Broccoli" effect [1]. This happens when developers take a standard, repetitive school task and simply hide it behind game graphics. Because the learning mechanics are poorly integrated with the actual gameplay, students will quickly realize they are just doing homework and will become bored. Furthermore, games with static difficulty curves will discourage players. If a games difficulty does not adapt, students who learn quickly will find the content too easy and lose focus, while those who struggle will find it too difficult and become frustrated [2]. Finally, games with low replayability will offer little incentive for students to return. Chronicles of Arithmos will address these issues. The system will use integrated mechanics where math acts as the primary variable that determines an actions output. It will also feature an Adaptive Difficulty Algorithm that will scale the complexity of the equations to match the player's progress. To ensure replayability without manual content creation, the system will use Automatic Quest Generation system.

The primary purpose of this project will be to reduce Mathematics Anxiety among Grade 4-6 students. Richardson and Suinn (1972) defined this as "a feeling of tension and anxiety that interferes with the manipulation of numbers" [3]. This phenomenon creates a psychological barrier; when students experience this tension, they will struggle to perform well in academics regardless of their actual aptitude or intelligence. Studies by Ashcraft (2002) further suggested that high math anxiety will occupy a student's working memory capacity [4]. This means that because the student's brain is actively busy processing fear and worry, there are fewer mental energy left available to actually solve the math problem. By gamifying these math operations within a low-stakes, fantasy context, the game will aim to reduce the negative emotional responses usually associated with classroom drills. The system will provide an immediate, guaranteed feedback loop where a correct calculation will result in a tangible in-game "Critical Hit". Seeing immediate success will provide rewarding reinforcement, which will potentially recondition the learner's association with arithmetic from fear to a feeling of empowerment (Gee, 2003) [5]. By providing a safe environment where failure will simply result in a "Game Over" screen rather than a failing grade, students will be able to practice without fear. To further support this low-stakes learning, every town will feature a Training Hall where players can safely practice their calculation speed and combat mechanics against a Training Dummy with infinite health, allowing them to manually exit the practice session at any time.  Additionally, the game will feature a Enemy Auto-Scaling System to ensure that combat remains challenging regardless of the users current level, as well as a Peer-to-Peer (P2P) Multiplayer mode that will allow cooperative learning and social engagement among players.

The story will begin in the Plains of Origin, where the protagonist will awaken to find the world filled with "Anomalies," which are chaos fractures caused by the breakdown of world laws. Guided by Bron, who will act as a main mentor character for physical combat, and Martha, who will act as a main mentor character for magical theory, the player will complete a tutorial. The player will learn that their younger sister, Lily, who will serve as the central narrative driver, has been afflicted by a curse. To cure her, the player must restore the world's logic. The protagonist will travel across four distinct biomes, each guarded by a corrupted elemental force. They will recover fragments from the Forest Golem, the Pharaoh's Guard, the Fenrir wolf, and the Demon Lord. The journey will culminate in the Void Dimension. Here, the player will confront The Numeromancer, the source of the chaos and final antagonist of the game, utilizing both combat and math skills to stabilize the realm.
...
The Magic Swordsman class will wield enchanted blades and rapiers. The Rapier will be a thrusting sword. The Wind Blade will be a gust-themed sword. The Leaf Cutter will be a nature-themed rapier. The Elven Rapier will be a mystical thrusting sword. The Swift Blade will be a fast, lightweight sword. The Whisper Edge will be a silent blade. The Mirage Rapier will be an illusionary sword. The Heatwave Saber will be a desert-themed blade. The Dust Devil Blade will be a sandy thrusting sword. The Golden Epee will be an ornate rapier. The Sun-Strike Sword will be a bright blade. The Chill Spike will be a cold-themed thrusting sword. The Frozen Needle will be an icy rapier. The Aurora Blade will be a light-themed cold sword. The Ice Queen's Rapier will be a royal frozen blade. Zero Kelvin will be an ultimate freezing sword. The Searing Saber will be a hot blade. The Molten Rapier will be a liquid fire sword. The Blaze Edge will be a flaming blade. The Phoenix Tail will be a fiery magical sword. The Volcanic Spike will be a molten thrusting sword.
...
For the Knight, Provoke will force enemies to target the player. Shield Bash will deal physical damage with a chance to stun. Cover will allow the knight to take damage in place of a low-health ally. Iron Defense will greatly increase defense. Guard Ally will protect a selected ally from all physical attacks. Shield Wall will increase the entire party's defense. Fortify will reduce damage taken by the user while skipping their turn. Sentinel will counter attack whenever hit physically. Justice Strike will deal damage based on the user's current defense. Heavy Charge will deliver a high damage but low-accuracy strike. Taunt will lower enemy attack but ensure they target the user. Unbreakable Will will grant immunity to status ailments. Phalanx will increase physical and magic defense for the user. Retribution will reflect a portion of physical damage back to the attacker. Castle of Stone will make the party immune to all damage for a turn.
...
This module will act as the primary combat reward system by calculating the outcome of an action based on the speed and accuracy of the provided answer. It will apply double damage (2.0x) for fast and correct answers, normal damage for slow but correct answers, half damage (0.5x) for fast but incorrect answers, and a missed attack for slow and incorrect answers. Users will engage with this module by inputting their math answers to receive immediate combat results based on their performance.
...
This module will feature a combat calculation step where the specific outcome of an action is directly determined by the input speed and accuracy of the provided answer. The user will interact with this module by reacting quickly with their keystrokes or screen taps to input their answers, receiving immediate visual and sound feedback based on their final speed and accuracy. This calculation will apply to all combat commands, including attacks and healing spells, resulting in the following outcomes based on the player's performance:
...
The system does not currently support advanced algebra, calculus, or non-integer results (fractions/decimals). To maintain combat flow, the math generator is strictly restricted so that all division problems calculate to exact whole numbers, avoiding fractions or decimals entirely. Furthermore, the system imposes a hard limit on the multiplier and the divisor (the second number in any multiplication or division problem), capping them at a range of 1 to 20. This specific numerical limitation applies universally to every combat encounter, including advanced multi-part equations.
...
The multiplayer feature relies on the stability of the hostâ€™s internet connection. As the system utilizes a direct P2P handshake, high latency or packet loss on the host side may result in desynchronization of the Math Timer for connected clients.
...
[3] F. C. Richardson and R. M. Suinn, "The Mathematics Anxiety Rating Scale: Psychometric data," Journal of Counseling Psychology, vol. 19, no. 6, pp. 551â€“554, 1972. [Online]. Available: https://www.google.com/search?q=https://psycnet.apa.org/record/1973-09757-001

[4] M. H. Ashcraft, "Math anxiety: Personal, educational, and cognitive consequences," Current Directions in Psychological Science, vol. 11, no. 5, pp. 181â€“185, 2002. [Online]. Available: https://journals.sagepub.com/doi/10.1111/1467-8721.00196
