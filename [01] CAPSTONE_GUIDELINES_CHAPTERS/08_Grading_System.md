...
| **Rubric for Panel Member Grading – Capstone 1** | **Percentage** |
| :--- | :--- |
| Capstone Manuscript (Group Grade) | 40% |
| Oral Examination (Individual Grade) | 20% |
| *Note: Total seems low in source text, implied remaining is typically Adviser or not listed, but following source 40+20* | |

### B. Capstone 2

| **Rubric for Panel Member Grading – Capstone 2** | **Percentage** |
| :--- | :--- |
...
| All major modules and features of the system’s output as defined after theproposal stage are delivered. The credit shall be based on the percentage of delivered items. | 10 |
