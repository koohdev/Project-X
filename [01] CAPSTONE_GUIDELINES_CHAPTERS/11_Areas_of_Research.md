...
*   Incorporation of back-up and recovery features (for projects which will use a DBMS that has no such feature)
*   Archiving
*   Complete data entry components
*   Proper maintenance features
*   Complete reports
*   Data entry validation and error trapping
*   Validation, security, data accuracy and integrity features
*   Network set-up
...
*   Types of inventory items – 5 to 10 product lines; 5 to 10 items per product line
*   Warehouse capacity
...
*   Suppliers
*   Valid test data – 5 to 10 product lines; 5 to 10 items per product line
...
**General requirements:**
*   Considerations for multimedia systems
*   Dynamic pages (components of a page must be stored and accessed in a database)
...
*   Search engine
*   Report generation
*   Meta tags & hyperlinks
*   E-consultation module – bulletin board or message board or send e-mail inquiry through browser
*   Security
*   Uploaded
*   Required development tool/ programming languages: HTML, VBScripts, JavaScripts, XML, PHP, ASP, Perl and other web development programming languages
...
**Focus of Research:**
*   Automated Tool that combines both process and data views of systems
